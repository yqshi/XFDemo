...
public class IatDemo extends Activity implements OnClickListener {
    ...
    private void initLayout() {
        ...
        btnPlayer = (Button) findViewById(R.id.iat_play);
        btnPlayer.setOnClickListener(IatDemo.this);
    }
            ...
            case R.id.iat_play:
                ...
                if (file.exists()) {
                    try {
                        ...
                        btnPlayer.setText(mediaPlayer.getDuration() / 1000 + "s");
                        Log.e("TAG", mediaPlayer.getDuration() / 1000 + "s");
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
